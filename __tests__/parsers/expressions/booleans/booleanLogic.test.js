...
test("single", () => {
  expect(toValue(parse(booleanLogic)("true")).evaluate().value).toBe(true)
})
...
test("or", () => {
  expect(toValue(parse(booleanLogic)("true | false | false")).evaluate().value).toBe(true)
})
...
test("not or", () => {
  expect(toValue(parse(booleanLogic)("!true | false")).evaluate().value).toBe(false)
})

test("precedence", () => {
  expect(toValue(parse(booleanLogic)("false | true & true")).evaluate().value).toBe(true)
  expect(toValue(parse(booleanLogic)("!false | (!true & true)")).evaluate().value).toBe(true)
})
