...
`
    ...
    expect(result.expressions[0].keys[0].name).toBe("scope")
    expect(result.expressions[0].expressions[0]).toBeInstanceOf(Scope)
    expect(result.expressions[0].expressions[0].keys[0].name).toBe("k")
...
`
    ...
    expect(result.expressions[0]).toBeInstanceOf(Scope)
    expect(result.expressions[0].keys[0].name).toBe("arr")
