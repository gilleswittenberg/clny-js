...
describe("Application", () => {
  ...
  describe("Type", () => {
    ...
    test("Null", () => {
      ...
      const type = new Type("Null", null, null, null, null, null, null, null, true)
    ...
    test("Boolean", () => {
      ...
      const type = new Type("Boolean", null, null, null, null, null, null, null, true)
    ...
    test("Number", () => {
      ...
      const type = new Type("Number", null, null, null, null, null, null, null, true)
      const application = new Application(type, number)
      const environment = new Environment()
    ...
    test("String", () => {
      ...
      const type = new Type("String", null, null, null, null, null, null, null, true)
      const application = new Application(type, number)
      const environment = new Environment()
      expect(application.evaluate(environment)).toBe("5")
    })
